...
public interface ITicketService
{
    ...
    public Task<Ticket?> UpdateTicketAsync(int ticketId, TicketSystemUpdateDto dto,CancellationToken ct);
    public Task<Ticket?> UpdateTicketAsync(int ticketId, TicketEditDto dto, CancellationToken ct);
    ...
    public Task RemoveAttachmentByTicketId(int ticketId, string attachmentId, CancellationToken ct);
}